...
// Types
import { IChangeNewEmailValues, IChangePasswordFormValues, IOtpValues, IProfileInfoValues, IUserInfo } from './types';
...
const UserProfilePage = () => {
  ...
  const [initialProfileInfoValues, setInitialProfileInfoValues] = useState<IProfileInfoValues>(InitialProfileInfoValues);
